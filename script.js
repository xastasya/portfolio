...
{ id:2, title:'Твич оформление BlackRaven', cat:'stream', catName:'Graphic Design', catName_ru:'Graphic Design', desc_ru:'Стрим', desc_en:'Stream', year:'2026', tools:'Figma, Illustrator', type_ru:'Брендинг', type_en:'Branding', 
  ...
  'iframe:https://kinescope.io/embed/fx5L1eZJHNF86J4vePYnFE:56.25%',   
...
{ id:4, title:'Твич оформление The Salem Cat', cat:'stream', catName:'Graphic Design', catName_ru:'Graphic Design', desc_ru:'Стрим', desc_en:'Stream', year:'2026', tools:'Figma', type_ru:'Брендинг', type_en:'Branding',
  ...
  images:[
    ...
    'assets/images/s3.png',
     'iframe:https://kinescope.io/embed/78Zar6rLUfQ4ZdaDbuPh2f:55.51%',
...
{ id:17, title:'Базовые модели людей', cat:'3d', catName:'3D', catName_ru:'3D', desc_ru:'Базовые модели стилизованных тел мужчины и женщины. Оптимизированная топология, готовая для дальнейшего скульптинга или риггинга.', desc_en:'Stylized male and female base meshes. Optimized topology, ready for further sculpting or rigging.', year:'2024', tools:'Blender, Photoshop', type_ru:'3D', type_en:'3D', images:[
  ...
  desc_ru:'Фестиваль проходит несколько дней на открытом воздухе в режиме полного отказа от гаджетов. Концепция цифрового детокса отражена в визуальном языке постера. В основе композиции лежит сочетание природной чистоты зелёных холмов и синего неба с тактильной теплотой бабушкиного кресла как символа домашнего уюта. Шрифтовое решение дополнено элементами детской непосредственности в виде мыльных пузырей. Текстура телевизионных помех в авторской анимации вносит оттенок андеграундной эстетики и лёгкого визуального «шума», подчёркивая атмосферу бессонной ночи.',
  desc_en:'The festival takes place outdoors over several days with a complete ban on gadgets, offering a full digital detox. This concept is embedded in the posters visual language. The composition blends the natural purity of green hills and blue sky with the tactile warmth of a grandmothers armchair as a symbol of cosiness. The typography incorporates childlike playfulness through soap bubble motifs. The texture of TV static in the animated version introduces an underground aesthetic and a subtle visual "noise," capturing the restless spirit of a sleepless night.',
  year:'2026',
  ...
  catName:'Graphic Design',
  catName_ru:'Graphic Design',
  desc_ru:'Задача состояла в формировании позитивной ассоциации и привлечении молодой аудитории к идеям адопции и благотворительной помощи. В визуальном решении собака помещена на фоне чистого неба, что создаёт ощущение лёгкости, надежды и нового начала. Японский дорожный знак «Осторожно, кошки» добавляет иронии и культурный код, смягчая восприятие темы бездомных животных. Такой контраст между серьёзностью проблемы и лёгкой, даже игровой подачей снимает барьеры и побуждает молодёжь забирать кошек и собак домой, а также поддерживать приют.',
  desc_en:'The goal was to create a positive association and engage a younger audience in adoption and charitable support. The visual solution places a dog against a clear sky, evoking a sense of lightness, hope, and a fresh start. The Japanese road sign "Caution Cats" adds a touch of irony and cultural reference, softening the perception of animal homelessness. This contrast between a serious issue and a light, almost playful tone removes emotional barriers, encouraging young people to adopt homeless cats and dogs and to support shelter organisations.',
  year:'2026',
  tools:'Illustrator, Photoshop',
  type_ru:'Постер',
  type_en:'Poster',
